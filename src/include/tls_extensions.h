...
KeyShares parse_key_share_groups_extension(unsigned char * buffer, unsigned short len);
Vector parse_signature_algorithms_extension(unsigned char * buffer, unsigned short len);
//Vector parse_psk_key_exchange_modes_extension(unsigned char * buffer, unsigned short len); // BROKEN
